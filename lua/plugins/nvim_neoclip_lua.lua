...
-- Neoclip
--
-- A clipboard manager for neovim inspired by for example clipmenu.
...
-- select an entry in the history using telescope or fzf-lua which then
-- gets populated in a register of your choice.
--
